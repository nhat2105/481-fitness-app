  ...
  return (
    <View>
      <ScrollView>
            ...
            <StepCard stepNum={"03"} title={"Capture your progress"} description={"Look at the lens, chins up, straighten your posture. Flex your muscle, or make a pose, then cheese!"}/>
